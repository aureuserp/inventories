    ...
    protected function getHeaderActions(): array
    {
        return [
            ...
            Actions\Action::make('validate')
                ...
                ->modalHeading(__('inventories::filament/clusters/operations/resources/receipt/pages/edit-receipt.header-actions.validate.modal-heading'))
                ->modalDescription(__('inventories::filament/clusters/operations/resources/receipt/pages/edit-receipt.header-actions.validate.modal-description'))
                ->extraModalFooterActions([
                    Actions\Action::make('no-backorder')
                        ->label(__('inventories::filament/clusters/operations/resources/receipt/pages/edit-receipt.header-actions.validate.extra-modal-footer-actions.no-backorder.label'))
                        ->color('danger')
                        ->action(function (Operation $record) {
